    ...
    <div ref={containerRef} className="bg-white min-h-screen font-sans text-black-900 selection:bg-black-100">
      ...
      <section className="relative min-h-[70vh] flex flex-col items-center justify-center px-6 text-center pt-20">
        <div className="max-w-4xl mx-auto">
          <p className="hero-text text-[10px] tracking-[0.5em] text-black-400 mb-12">The House of Carpe Diam</p>
          ...
          <p className="hero-text max-w-2xl mx-auto text-sm md:text-base text-black-500 leading-relaxed tracking-wide uppercase px-4">
      ...
      <section className="reveal-section py-32 px-6 bg-[#fafafa]">
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-[10px] uppercase tracking-[0.3em] text-black-400">Founded with Certainty</p>
          </div>
        </div>
      </section>
      ...
      <section className="reveal-section py-32 px-6">
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
          <div>
            <p className="text-[10px] uppercase tracking-[0.4em] text-black-400 mb-6">The Foundation</p>
          ...
          <div className="pt-12 lg:pt-32">
            <div className="w-full h-px bg-black-100 mb-12" />
            <p className="text-sm font-serif italic text-black-500 leading-relaxed">
      ...
      <section className="reveal-section py-32 px-6 bg-black text-white overflow-hidden">
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div>
            <p className="text-[10px] uppercase tracking-[0.4em] text-black-500 mb-6 font-sans">The Creative Vision</p>
      ...
      <section className="reveal-section py-40 px-6 text-center">
        <div className="max-w-3xl mx-auto">
          <p className="text-[10px] uppercase tracking-[0.4em] text-black-400 mb-10">The Journey</p>
          ...
          <p className="text-black-600 leading-relaxed max-w-2xl mx-auto">
      ...
      <section className="reveal-section py-32 px-6 border-t border-black-100">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-sm font-serif italic text-black-400 mb-12">The Interpretation</p>
          <h2 className="text-3xl md:text-5xl font-serif mb-16 decoration-black-200 decoration-1 underline-offset-8">
            Contemporary, restrained, and quietly confident.
          </h2>
          <p className="text-xs uppercase tracking-[0.5em] text-black-400">
            Carpe Diam ©
          </p>
        </div>
      </section>
